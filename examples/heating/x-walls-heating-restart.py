""" This file opens a restart from a previously run simulation of examples/filling/x-walls-periodic-y.py
We have walls in the x direction that are loaded from restart, deleted from the system, and replaced by walls
